function FixedMenu() {
  return (
    <div className="fixed">
      <div className="fixed__auth">
        {" "}
        <a href="#" target="_blank" rel="noopener noreferrer">
          {" "}
          <button className="round__btn fixed__btn auth__btn">Войти</button>
        </a>
      </div>
      <div className="fixed__socials">
        <ul className="fixed__socials-list">
          <li className="fixed__socials-tg">
            <a
            ...
            >
              {" "}
              <button className="round__btn fixed__btn">
                <svg
                  viewBox="0 0 20 21"
                  fill="none"
          ...
          <li className="fixed__socials-sc">
            <a
          ...
          <li className="fixed__socials-youtube">
            <a
